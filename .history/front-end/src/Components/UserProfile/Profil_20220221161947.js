                ...
                <div className="registration-form">
                    <Form>
                        ...
                        <div className="form-group row">
                            <div className="form-icone" style={{flexDirection:"row"}}> 
                                <img src="https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460__340.png" alt= "Avatar" className="avatar">
